...
% Colophon
\colophon{This document has been prepared using the Linux operating system and free softwares: \\[0.25cm]
\begin{tabular}{lc}
...
\end{tabular}\\[0.5cm]
\textcopyright Sébastien Le Roux\\[0.25cm]\includegraphics[width=3cm]{img/by-nc.eps}}
