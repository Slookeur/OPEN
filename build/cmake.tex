...
\begin{script}
\confb{set}{\confa{CMAKE\_C\_FLAGS} \magenta{"-O3 -fopenmp"}}
\confb{set}{\confa{CMAKE\_Fortran\_FLAGS} \magenta{"-O3 -fopenmp"}}
\end{script}
...
\confb{add\_compile\_definitions}{PACKAGE\_LOGO=\magenta{"pixmaps/logo.png"}}
\end{script}
\\[-0.25cm]
...
\confb{set}{\bftt{INSTALL\_DIR} "\varc{CMAKE\_INSTALL\_PREFIX}/\varc{CMAKE\_INSTALL\_DATADIR}"}
