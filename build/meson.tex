...
The last keyword on the \confb{executable}{} instruction, defines if the binary is to be installed or not (see Sec.~{}):
\begin{center}\bftt{install : }{\em{true}} \texttt{/} {\em{false}}\end{center}
\noindent It is possible to find multiple \confb{executable}{} instructions in the file \bftt{meson.build}. 
