...
\noindent In the \bad{Build-Depends} section if you are using CMake, replace \texttt{automake} and \texttt{autoconf} by \texttt{cmake}. 
\newpage
...
\end{scripti}
\\[-0.5cm] This will trigger the build of the source and binary packages from your Salsa repository.
...
\end{itemize}
For more information on \bftt{gbp}: \href{https://wiki.debian.org/PackagingWithGit}{https://wiki.debian.org/PackagingWithGit}
\newpage
