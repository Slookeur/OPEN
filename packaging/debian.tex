...
\item The software license for every third-party library you ship together with the program, or, for files in your source code with specific copyright. 
\end{itemize}
...
\bad{License:} License-Keyword
 Text of the license
\end{script}
\noindent \texttt{License-keyword} information, should use the SPDX identifier: \href{https://spdx.org/licenses/}{https://spdx.org/licenses/}
\newpage
\noindent Example: 
{\footnotesize{
\begin{script}
...
\end{script}
\\[-0.75cm]
\noindent Note that the "\bftt{lintian}" command, that refers to the alias defined in section [Sec.~\ref{dprereq}], 
