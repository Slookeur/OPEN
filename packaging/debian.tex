...
\vspace{-0.25cm}
\begin{scripti}
\uprompt{~/program-1.2.12} \bftt{gbp} \rtt{dch} \btt{-R}
\end{scripti}
...
\uprompt{~/program-1.2.12} git push
\end{scripti}
\\[-1.25cm]
...
\end{scripti}
\\[-1cm]
This will download the latest sources using the information in the "\texttt{debian/watch}" file.
