...
In the following I use the "{\em{section(s)}}" terminology to refer to parts of the file that might be refered to as "{\em{field(s)}}" in other Debian packaging manuals. 
Similarly I use the terminology "{\em{\texttt{Package:} instruction}}" for parts of the file that might usually be refered to as "{\em{stanzas}}". \\[0.25cm]
