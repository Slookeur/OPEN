...
Note that you can use the \href{https://www.freedesktop.org/software/appstream/metainfocreator/\#/}{AppStream MetaInfo Creator} to create this file. 
\end{itemize}
...
\\
\noindent "\texttt{\blue{rawhide}}" is the development version of Fedora, usually the latest released
version + 1. \\
If the latest released is version 39 (f39), then rawhide will released as f40. \\
You can list all available target distributions using:
{\footnotesize{
\begin{script}
\fprompt{~} \bftt{koji} \rtt{list-targets}
\end{script}
}}
