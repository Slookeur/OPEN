...
An example of custom MIME association file is provided in the appendix [App.~\ref{mime}].
...
An example of desktop entry for a desktop application is provided in the appendix [App.~\ref{desktop}].
